class AnswerFormTypesController < ApplicationController
  ...
  private
    ...
    def answer_form_type_params
      params.require(:answer_form_type).permit(:name, :client_form_type_id, components_attributes:[:id, :is_text_area, :name, :_destroy, properties:{}, fields_attributes:[:id, :name, :field_type, :_destroy, posible_answer_attributes:[:id, :answer, :_destroy]]])
    end
end
